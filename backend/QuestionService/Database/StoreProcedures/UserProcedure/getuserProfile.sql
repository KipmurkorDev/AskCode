CREATE  or Alter PROCEDURE getProfile(
  ...
  SELECT Question.user_id, Question.title, Question.[description], Question.question_id, Question.created FROM Question WHERE Question.user_id=@user_id and isDelete='0'
