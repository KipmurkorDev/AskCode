CREATE  or Alter PROCEDURE getProfile(
  ...
  SELECT Comment.user_id, Comment.answer_id, Comment.comment_id, Comment.comment_descprition, Comment.comment_created FROM Comment WHERE Comment.user_id=@user_id and isDelete='0'
END